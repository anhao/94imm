...
class Spider():
    ...
    def get_url(self):
        ...
        for i in range(1, 10):
            ...
            for img_li in img_ul:
                ...
                title = img_li.find("p", class_="p_title").find("a").text
                try:
    ...
    def get_img_url(self):
        ...
        for page_url in reversed(self.page_url_list):
            ...
            title = img_div_soup.find("div", class_="weizhi").find("h1").text
...
if __name__ == '__main__':
    for i in [{"page": 28, "type": "siwameitui", "type_id": 2}, {"page": 11, "type": "weimei", "type_id": 3},
              {"page": 11, "type": "loli", "type_id": 4},{"page": 9, "type": "xueshengmei", "type_id": 4}]:
